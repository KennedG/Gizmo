exports.run = async (client, message, args) => {
  const roleA = await message.guild.roles.cache.find(role => role.id === "852369289273278484"); 
  ...
  if (
    ...
    await roleA.setPermissions(67567680).catch(console.error);
//Assista ao vídeo para entender como setar as permissões https://youtu.be/P7jDV0JnMRc
    ...
    await roleA.setPermissions(2411585).catch(console.error);
//Assista ao vídeo para entender como setar as permissões https://youtu.be/P7jDV0JnMRc
